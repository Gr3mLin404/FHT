...
class Installer:
    ...
    def building(self, args):
        ...
        if args[0] == 'ninja':
            ...
            os.system('cmake --build . --config Release --parallel 16')
            if args[0] == 'win32':
    ...
    def parse_args(self):
        parser = argparse.ArgumentParser(usage='sudo python3 install.py -b ninja 16')
        parser.add_argument('-b', '--build', nargs=1, required=True, help='Build FHT', dest='b')
